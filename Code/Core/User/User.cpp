...
bool User::ProjectWrapper::registerProjects(std::map <Project::Project, accessDegree, projectComparator> unclaimedProjects) {
    for(auto& userProject: unclaimedProjects) {
        this->associatedProjects[userProject.first] = userProject.second;
    }
    return true;
...
std::map <Project::Project, User::accessDegree, User::projectComparator> User::ProjectWrapper::fetchRegisteredProjects(
    std::vector <shared_ptr<Project::Project>> registeredProjects) {
    std::map <Project::Project, accessDegree, projectComparator> resultProjects;
...
std::map <Project::Project, User::accessDegree, User::projectComparator> User::ProjectWrapper::fetchAllRegisteredProjects() {
...
User::ThemeWrapper::~ThemeWrapper() {};
