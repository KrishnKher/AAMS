...
public:
    ...
    bool registerProjects(std::map <Project::Project, accessDegree, projectComparator> unclaimedProjects);
    bool deregisterProjects(std::vector <Project::Project> claimedProjects);

    std::map <Project::Project, accessDegree, projectComparator> fetchRegisteredProjects(
        std::vector <shared_ptr<Project::Project>> registeredProjects);
    std::map <Project::Project, accessDegree, projectComparator> fetchRegisteredProjects(
        std::vector <Project::Project> registeredProjects);
    std::map <Project::Project, accessDegree, projectComparator> fetchAllRegisteredProjects();
