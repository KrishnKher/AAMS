...
angle=0,
contents={%
  \includegraphics[width=\paperwidth,height=\paperheight]{SD/images/CodeCivilDesign.png}
  }%
}
...
\AddToShipoutPictureBG*{\AtPageLowerLeft{% 
  \color{Cerulean}\rule{.16 \paperwidth}{\paperheight} }
   \:
   \:
   \;
   \;
 ...
 ~\texttt{\projectName~SD Documentation}}
  \end{turn}
...
& \Large Software Design Specification\\ % Here the title of your work
& \\
